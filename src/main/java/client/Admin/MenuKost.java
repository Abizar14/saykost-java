...
//            JOptionPane.showMessageDialog(null, "eRROR SAAT MENYIMPAN DATA");
	...
	/**
	 * This method is triggered when the "Upload" button is clicked.
	 * It opens a file chooser dialog to select an image file.
	 * The selected image file is then displayed in a label and its name is set in a text field.
	 * If no image file is selected, a message is displayed in the text field.
	 * If an error occurs during the process, an error message dialog is shown.
	 */
