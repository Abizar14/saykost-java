...
import client.Admin.MenuDashboard;
import javax.swing.*;
...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("./img/icons8_close_30px.png"));
    }
...
//          validate if the user is admin
            if (loginAdmin != null) {
                ...
                // Buat instance DashboardAdmin
                DashboardAdmin da = new DashboardAdmin();

                // Tambahkan komponen MenuDashboard ke dalam pn_utama
                pn_utama.removeAll();
                pn_utama.add(new MenuDashboard());

                // Revalidasi dan repaint pn_utama
                pn_utama.revalidate();
                pn_utama.repaint();

                // Set DashboardAdmin menjadi visible setelah manipulasi pn_utama selesai
                da.setVisible(true);

                // Tutup frame saat ini (jika ini adalah JFrame)
                this.dispose();
