...
//					boardingHouseEntity.getName());
	...
	/**
	 * Retrieves data from the database and formats it into a TableModel.
	 * The data includes information about boarding houses, such as name, size, price, address, description,
	 * number of rooms, category, and creation date. The data is retrieved from the boarding_houses and
	 * categories tables, with a left join on the category ID. The data is sorted by creation date in descending order.
	 *
	 * @return a TableModel containing the formatted data, or null if an error occurs
	 */
	public static @Nullable
	...
	/**
	 * Retrieves data from the database based on a given name and returns it as a TableModel object.
	 * The data includes information about boarding houses, such as their name, size, price, address,
	 * description, number of rooms, category, and creation date. The data is retrieved from the
	 * 'boarding_houses' table and joined with the 'categories' table using a left join on the 'category' column.
	 * The result is filtered by the name and ordered by the creation date in descending order.
	 *
