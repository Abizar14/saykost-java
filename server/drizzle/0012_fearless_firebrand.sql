ALTER TABLE `boarding_houses` MODIFY COLUMN `id` int AUTO_INCREMENT NOT NULL;--> statement-breakpoint
...
ALTER TABLE `boarding_houses` ADD PRIMARY KEY(`id`);--> statement-breakpoint
